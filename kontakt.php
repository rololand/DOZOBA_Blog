...
<html lang="pl">
<?php
	$tytul = "Skontaktuj się z DOZOBA.PL";
	$description = "Skontaktuj się z autorem bloga";
		...
		<!--content-->
			<div class="row">
				<div class="col-sm-12 col-md-8">
					...
					<p>Przepraszam, ten dział jest w przygotowaniu.</p>
					<p>Jeżeli chcesz się ze mną skontaktować, to najszybszą drogą jest zostawić wiadomość na <a href="https://www.facebook.com/rololandofficial/" target="_blank" title="facebook">Facebook'u</a></p>
...
<script>
	$('#kontakt').addClass("active menuItem");
</script>
</body>
</html>