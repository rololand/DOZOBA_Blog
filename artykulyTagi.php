...
<?php
	...
	$tytul = "Co warto zobaczyć w kategorii ".$_GET['tagname']." - DOZOBA.PL";
	$description = "Co warto zobaczyć w kategorii ".$_GET['tagname'].". Wszystkie artykuły z wybranej kategorii";
		...
		<!--content-->
			<div class="row">
				<div class="col-sm-12 col-md-8">
					<?php include("php/tagiskrypt.php"); ?>
